...
# Assume X_train is your training data and model is your trained model
...
with mlflow.start_run() as run:
    mlflow.xgboost.log_model(
        ...
        artifact_path="model",
        signature=signature,
        input_example=X_train.iloc[[0]],  # or a representative input example
        registered_model_name="shoba_ws.default.fraud_xgb_model"
    )
...
model_name = "fraud_xgb_model"  # Replace with your actual model name
model_version = 1  # Replace with your actual model version number
